...
A.microMove(10);
	...
	private void spaceBarWasPressed() {
		...
		int robotXLocation = A.getX();
		int robotYLocation = A.getY();
		...
		JOptionPane.showMessageDialog(null, "skull eye");
		}
		...
		JOptionPane.showMessageDialog(null, "bottle");
		}
		if(robotXLocation == 690 && robotYLocation == 240) {
		JOptionPane.showMessageDialog(null, "cannon");
		}
